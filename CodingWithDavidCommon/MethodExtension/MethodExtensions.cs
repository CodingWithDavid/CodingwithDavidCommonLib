...
public static class MethodExtensions
{
    ...
    {
        bool result = !double.TryParse(num, out _);
        return result;
    }
    ...
    {
        StringBuilder sb = new (note ?? string.Empty);
        if (sb.Length != 0)
        {
    ...
    {
        _ = float.TryParse(str, out float result);
        return result;
    }
    ...
    {
        _ = decimal.TryParse(str, out decimal result);
        return result;
    }
    ...
    {
        _ = double.TryParse(str, out double result);
        return result;
    }
